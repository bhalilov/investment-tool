...
from investment_tool.x_thread_model import display_text, explicit_x_links, media_keys
...
def non_photo_media_placeholders(
    ...
    from investment_tool.x_thread_model import non_photo_media_placeholders as model_non_photo_media_placeholders
...
def media_placeholder_tags(
    ...
    from investment_tool.x_thread_model import media_placeholder_tags as model_media_placeholder_tags
